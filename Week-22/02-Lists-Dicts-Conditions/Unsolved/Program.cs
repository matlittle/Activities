...
class Program
{
  static void Main (String[] args)
  {
    ...
    Program.getStudentInfo(students);
     ...
     */
     Console.Write("Would you like to add another student?");
     string newStudentConfirm = Console.ReadLine();

     if (newStudentConfirm !== "y")
     {
       Program.
     }
  ...
  private list getStudentInfo(list students) {
    ...
    else 
    {
      ...
      studentInformation.add("middleName", middleName);
      studentInformation.add("lastName", lastName);
